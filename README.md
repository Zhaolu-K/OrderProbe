...
- ⚠️ **Structure Recognition is Hard**: When internal order is scrambled, LLMs struggle to recognize the correct structure - zero-shot recovery frequently below 35% even for frontier systems
...
- **Syntactic Categories**: 6 major linguistic structures (Parallel Coordinate, Subject-Predicate, Verb-Object, Modifier-Head, Serial Verb, Idiomatic Compounds)
