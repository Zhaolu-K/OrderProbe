# Logical Validity (S_Log) Calculator

This module implements the Logical Validity (S_Log) evaluation metric using Natural Language Inference (NLI) models. S_Log measures whether generated idiom explanations logically entail their canonical definitions.
...
### Use Cases
- **High S_Log + High S_Acc**: Reliable explanation
- **High S_Acc + Low S_Log**: Semantically similar but logically inconsistent
...
For integration with other metrics (S_Acc, S_Cons, robustness measures), combine S_Log with complementary evaluation approaches for comprehensive idiom explanation assessment.
